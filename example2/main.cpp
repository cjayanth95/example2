...
//    Mat inv;
//    threshold(img1,inv,254,255,THRESH_BINARY_INV);
//    cv::imwrite( "inv.jpg", inv);
//    cv::Mat img3= img1.clone();
//    img3.setTo(255);
    //Detect
    std::vector<cv::Rect> letterBBoxes1=detectLetters(img1 ,17 , 3 ,100);
    std::vector<cv::Rect> letterBBoxes2=detectLetters(img1, 140,20,100);
...
//            waitKey(10000000);
    ...
    for(int i=0; i< letterBBoxes2.size(); i++)
        cv::rectangle(img2,letterBBoxes2[i],cv::Scalar(255,255,0),3,8,0);
